...
/*------------------------------------------------------------------------------------------------------*/
/*									Ejercicio de casa práctica 06 Atomo									*/
/*------------------------------------------------------------------------------------------------------*/
...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.2f, 0.2f, 0.3f));
	sphere_draw();	
	...
	model = glm::translate(model, glm::vec3(0.0, 0.0f, 2.0f));
